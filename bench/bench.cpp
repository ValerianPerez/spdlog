...
void bench_single_threaded(int iters) {
    ...
    spdlog::info("");
    auto basic_field_st =
        spdlog::basic_logger_st("basic_fields_st", "logs/basic_fields_st.log", true);
...

    {
        ...
        auto basic_1ctx_st =
            spdlog::basic_logger_st("basic_1ctx_st", "logs/basic_1ctx_st.log", true);
...

    {
        ...
        auto basic_10ctx_st =
            spdlog::basic_logger_st("basic_10ctx_st", "logs/basic_10ctx_st.log", true);
